...
namespace TheMoonshineCafe.Data
{
    public class DbInitializer
    {
        public static void Initialize(MoonshineCafeContext context)
        {
            ...
            {
                new Event{title="event2", eventStart=DateTime.Parse("02/22/2022 02:20"), eventEnd=DateTime.Parse("02/22/2022 18:00"), refundCutOffDate=DateTime.Parse("02/22/2022 02:05"), bandId=3, maxNumberOfSeats = 23, currentNumberOfSeats=0, description="testing 1", ticketPrice=3.50, googleCalID="testID"},
                new Event{title="event1", eventStart=DateTime.Parse("02/22/2022"), eventEnd=DateTime.Parse("02/22/2022 02:00"), refundCutOffDate=DateTime.Parse("02/22/2022"),  bandId=1, maxNumberOfSeats = 23, currentNumberOfSeats=0, ticketPrice=3.50},
